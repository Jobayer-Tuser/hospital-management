 ...
 * Create Data
 * ----------------------------------------
 * Create Form Validation by Token Image File Name Generate 
 * and Validation Prior to Upload. If Validate Then Create Query 
 * will be Executed Upload to the Specified Directory. 
         ...
         <div class="card">
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-md-2">
                     <div class="pt-4">
                        <img class="rounded shadow mr-2 mo-mb-2" alt="" width="180" height="180" src="<?php echo $resc->asset('placeholder.jpg'); ?>" data-holder-rendered="true" id="div1" />
                     </div>
                  </div>
               </div>
            </div>
