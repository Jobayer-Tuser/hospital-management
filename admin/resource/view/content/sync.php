   ...
   if (!empty($fetchShopCart) && is_array($fetchShopCart)) {
      ...
      if (!empty($orderItemDetails) && is_array($orderItemDetails)) {
         ...
         foreach ($orderItemDetails as $eachItems) {
            ...
            $priceUpdate = (!empty($product[0]['updated_at'])) ? $misc->dateTime($product[0]['updated_at']) : $misc->dateTime($product[0]['created_at']);
                  ...
                  <ul class="list-group">
                     <li class="list-group-item">
                        ...
                        <div>
                           ...
                           <span class="float-right">' . $misc->dateTime($eachAdmin['created_at']) . '</span>
                        </div>
                        <div>
                           <span><strong>Updated Date:</strong></span>
                           <span class="float-right">' . $misc->dateTime($eachAdmin['updated_at']) . '</span>
                        </div>
                     </li>
                  </ul>
               </div>
                  ...
                  <li class="list-group-item">
                     ...
                     <div>
                        ...
                        <span class="float-right">
                           ' . $misc->timeOnly($eachDoctor['start_time']) . ' to ' . $misc->timeOnly($eachDoctor['end_time']) . '
                        </span>
                     </div>
                     <div>
                     ...
                     <div>
                        <span><strong>Created Date:</strong></span>
                        <span class="float-right">' . $misc->dateTime($eachDoctor['created_at']) . '</span>
                     </div>
                  </li>
               </ul>
            </div>
